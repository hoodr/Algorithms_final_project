...
class Image(object):
    ...
    def makeFeatureVector(self):
        ...
        return [self.numCorners,  self.ratioPixels , self.horizSym, self.vertSym, self.centroid[0], self.centroid[1], self.pca1, self.pca2, self.circles ** 2]
    ...
    def getPCA(self):
        if len(self.data) == len(self.data[0]):
            ...
            idx = eVal.argsort()[::-1]
            eVal = eVal[idx]
            self.pca1 = int(100 * eVal[0].real)
            self.pca2 = int(100 * eVal[1].real)
        return
